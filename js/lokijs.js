      ...
      if (this.persistenceAdapter !== null) {
        ...
        this.persistenceAdapter.loadDatabase(this.filename, function loadDatabaseCallback(dbString) {
          if (typeof (dbString) === 'string') {
            if (dbString == null || dbString.trim().length == 0 || dbString.trim() == "null") {
              console.warn('lokijs loadDatabase : Database EMPTY');
            } else {
            ...
            if (typeof (dbString) === "object") {
              console.log('Loaded as object. Stringifying...');
              self.loadJSON(JSON.stringify(dbString), options || {});
              cFun(self);
            } else {
